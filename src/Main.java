...
public class Main {
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // YOUR ANSWER HERE O(n^2) n=a n=b n=a*b
  ...
  // The time complexity is:
  // YOUR ANSWER HERE O(n) n= chars.length
